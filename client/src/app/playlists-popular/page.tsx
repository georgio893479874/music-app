...
export default function PlaylistsPopularPage() {
  ...
  useEffect(() => {
    async function fetchPlaylists() {
      ...
      const res = await axios.get<Playlist[]>(`${API_URL}/recommendation/user/${userId}/popular-playlists`)
  ...
  return (
    <div style={{ maxWidth: 1200, margin: '32px auto', padding: 32 }}>
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 18 }}>Popular Playlists</h1>
      {loading ? "Loading..." : (
