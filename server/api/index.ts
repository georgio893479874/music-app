...
export type CreateCommentDto = object;

export type UpdateCommentDto = object;
...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     */
    commentControllerFindAll: (params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/comment`,
        method: "GET",
        ...params,
